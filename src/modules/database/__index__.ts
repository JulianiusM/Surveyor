...
export const entities = [ActivityAssignment, ActivityAssignmentRole, ActivityPlan, ActivityPlanRequirement, ActivitySlot, ActivitySlotRole, DriversAssignment, DriversItem, DriversList, Event, EventRegistration, EventRegistrationDietary, PackingAssignment, PackingItem, PackingList, Session, Survey, SurveyCombination, SurveyResponse, Guest, GuestLink, Role, User];
