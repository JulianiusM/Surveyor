...
export const DEFAULT_PERM = (() => {
    ...
    const FULL_ITEM =
        PERM.ITEM_ADD | PERM.ITEM_EDIT | PERM.ITEM_EDIT_DESC | PERM.ITEM_DELETE;
    const FULL_MANAGE =
    ...
    const FULL_ACCESS =
        PERM.ACCESS_REGISTRATION | PERM.ACCESS_CREATE | PERM.ACCESS_VIEW | PERM.ACCESS_ADMIN | PERM.ACCESS_PARTICIPANTS;
