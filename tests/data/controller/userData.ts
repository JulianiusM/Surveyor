...
export const dashboardEntityData = [
    {
        ...
        mockData: {
            ...
            partSurveys: [{id: 'ps'}],
            ownPacklists: [{id: 'p'}],
            adminPacklists: [{id: 'ap'}, {id: 'p'}],
            partPacklists: [{id: 'pp'}],
            ownActivityplans: [{id: 'a'}],
            adminActivityplans: [{id: 'aa'}],
            partActivityplans: [{id: 'pa'}],
            ownDriverslists: [{id: 'd'}],
            adminDriverslists: [{id: 'ad'}],
            partDriverslists: [{id: 'pd'}],
            ownEvents: [{id: 'e'}],
            adminEvents: [{id: 'ae'}, {id: 'e'}],
            registeredEvents: [{id: 're'}],
        },
        expected: {
            owner: {
                surveys: [{id: 's'}],
                packingLists: [{id: 'p'}, {id: 'ap'}],
                activityPlans: [{id: 'a'}, {id: 'aa'}],
                driversLists: [{id: 'd'}, {id: 'ad'}],
                events: [{id: 'e'}, {id: 'ae'}],
            },
            participant: {
                surveys: [{id: 'ps'}],
